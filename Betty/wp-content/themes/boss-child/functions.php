...
function boss_child_theme_scripts_styles()
{
  ...
  wp_enqueue_script( 'wdm-js', get_stylesheet_directory_uri().'/js/wdm-script.js' );
  ...
  wp_register_script( 'wdm-buddyboss-main', get_stylesheet_directory_uri() . '/js/buddyboss.js', array( 'jquery'),10,true );
  wp_localize_script( 'wdm-buddyboss-main', 'translation', $translation_array );
  wp_localize_script( 'wdm-buddyboss-main', 'BuddyBossOptions', $buddyboss_js_vars );
  wp_enqueue_script( 'wdm-buddyboss-main' );
}
