    ...
    foreach((array)$fields as $field){ ?>
        <li id="position_<?php echo $field->ID; ?>" class="default">
            ...
            <span class="items-link">
                <a href="<?php echo bp_get_group_permalink( $bp->groups->current_group );?>admin/<?php echo $slug; ?>/fields-manage/?edit=<?php echo $field->ID;?>" class="button bb-edit-button" title="<?php _e('Change its title, description etc','boss');?>"><i class="fa fa-pencil"></i></a>
