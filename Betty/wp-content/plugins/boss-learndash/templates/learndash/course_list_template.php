...
$course_lessons_list = apply_filters( 'boss_edu_course_lessons_list', learndash_get_course_lessons_list( $post_id ) );
...
$short_description 	= empty( $course_options['sfwd-courses_course_short_description'] ) ?  get_the_excerpt($post_id) : $course_options['sfwd-courses_course_short_description'];
