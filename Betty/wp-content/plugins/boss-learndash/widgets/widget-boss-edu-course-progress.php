                ...
                $user_id = get_current_user_id();
                    ...
                    if( bp_is_active( 'groups' ) ){
                        ...
                        if ( !(empty($group_attached) || $group_attached == '-1') )	{
                            ...
                            $button = '<p class="bp-group-discussion"><a class="btn inverse" href="'. trailingslashit(home_url()).trailingslashit($bp->groups->slug).$group_data .'">'. sprintf( __('%s Discussion','boss-learndash'), LearnDash_Custom_Label::get_label( 'course' ) ).'</a></p>';
